...
if ( ! class_exists( 'Envira_Gallery_Themes' ) ) :
	...
	class Envira_Gallery_Themes {
		...
		/**
		 * Helper method to load required files.
		 *
		 * @since 2.0.0
		 *
		 * @return void
		...
		public function require() {
			require_once trailingslashit( plugin_dir_path( __FILE__ ) ) . 'src/templates.php';
		}
		/**
		...
		public function setup_constants() {
			...
			define( 'ENVIRA_GALLERY_THEMES_PLUGIN_VERSION', '2.0.4' );
		...
		public function register_envirabox_themes( $themes ) {
			...
			$themes[] = array(
				'value'  => 'infinity_dark',
				'name'   => __( 'Infinity (Dark)', 'envira-gallery-themes' ),
				'file'   => __FILE__,
				'config' => array(
					'arrows'          => 'true',
					'margins'         => array( 120, 0 ), // top/bottom, left/right.
					'gutter'          => '20',
					'thumbs_position' => 'side',
					'base_template'   => 'envirabox_infinity_template',
					'inner_caption'   => true,
				),
			);
			...
			$themes[] = array(
				...
				'name'   => __( 'Infinity (Light)', 'envira-gallery-themes' ),
				'file'   => __FILE__,
				'config' => array(
					'arrows'          => 'true',
					'margins'         => array( 120, 0 ), // top/bottom, left/right.
			...
			$themes[] = array(
				'value'  => 'classical_light',
				'name'   => __( 'Classical (Light)', 'envira-gallery-themes' ),
				'file'   => __FILE__,
				'config' => array(
					'arrows'          => 'true',
					'margins'         => array( 100, 0 ), // top/bottom, left/right.
					'gutter'          => '20',
					'thumbs_position' => 'bottom',
					'base_template'   => 'envirabox_classical_template',
					'inner_caption'   => true,
				),
			);
			$themes[] = array(
				'value'  => 'classical_dark',
				'name'   => __( 'Classical (Dark)', 'envira-gallery-themes' ),
				'file'   => __FILE__,
				'config' => array(
					'arrows'          => 'true',
					'margins'         => array( 100, 0 ), // top/bottom, left/right.
