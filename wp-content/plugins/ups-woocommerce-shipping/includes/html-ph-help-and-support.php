...
<tr valign="top" class="ph_ups_help_tab">
	<td class="titledesc" colspan="2" style="padding:0px">
		...
		<p>5. The details sent to PluginHive will include UPS Account Details for debugging purpose only</p>
		...
		<table class="ph_ups_help_table">
			...
			<tr>
				<td colspan="2">
					...
					Yes, I have the read the above points and agreed to send the details mentioned above for debugging purpose.
					<br/>
