...
class Welcome {
	...
	public function admin_welcome_css( $classes ) {
		...
		$upgrade_pages = array( 'envira-gallery-upgrade' );
	...
	public function enqueue_admin_styles() {
		...
		$welcome_pages = array( 'envira-gallery-get-started', 'envira-gallery-welcome', 'envira-gallery-support', 'envira-gallery-changelog', 'envira-gallery-upgrade' );
