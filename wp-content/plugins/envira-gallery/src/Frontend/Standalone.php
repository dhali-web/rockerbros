...
class Standalone {
	...
	public function __construct() {
		...
		add_filter( 'render_block_core/post-content', array( $this, 'insert_shortcode_into_post_block' ), 10, 2 ); // for W 5.9 + Block Themes.
		add_filter( 'single_template_hierarchy', array( $this, 'standalone_template_hierachy' ), 10, 1 ); // for W 5.9 + Block Themes.
